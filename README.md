...
## WARNING: This includes something called "Self-botting" since we´re automatic something outside the discord api, I´ve made it as safe as possible, and added extra security to the code. Otherwise you may face punishment from discord(VERY UNLIKELY, But it is against the TOS... kinda unfair that it is, but oh well)
